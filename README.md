...
> This project aims to implement a connection between a Ruby on Rails back-end and React front-end.
...
```bash command
$ git clone https://github.com/bienvenuushindi/hello-react-rails.git
```
